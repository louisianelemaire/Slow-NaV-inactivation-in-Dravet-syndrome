This repository contains the code to reproduce the figures of the manuscript "Depolarization block induction via slow ${\rm Na}_{\rm V}1.1$ inactivation in Dravet syndrome".
