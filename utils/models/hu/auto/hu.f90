...
!   Fast subsystem (no slow inactivation)
!----------------------------------------------------------------------
!----------------------------------------------------------------------
...
SUBROUTINE FUNC(NDIM, U, ICP, PAR, IJAC, F, DFDU, DFDP)
    ...
    DOUBLE PRECISION V, H, N, NBIS
    DOUBLE PRECISION IAPP, GNAMUT, GNAWT, GK, GL, ENA, EK, EL, TEMPDIFF, SHIFTM, TEMP
    DOUBLE PRECISION GNATOT, PNAV11
    DOUBLE PRECISION C, Q10M, Q10H, Q10N, SHIFTV
    ...
    ! sodium conductances
    GNAMUT = PNAV11 * GNATOT/2
    GNAWT = GNATOT * (1 - PNAV11/2)
    ...
    INAMUT = GNAMUT * MINFMUT ** 3 * H * (V - ENA)
